...
export default function ChairmanPortal() {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen lg:h-screen lg:overflow-hidden bg-slate-100 dark:bg-slate-950 text-slate-800 dark:text-slate-200 transition-colors duration-300 font-sans">
      {/* 1. PORTAL GREEN SIDEBAR */}
      <aside className="w-full lg:w-64 xl:w-72 bg-slate-900 border-b lg:border-b-0 lg:border-r border-slate-800 flex flex-col justify-between shrink-0 select-none lg:h-screen lg:sticky lg:top-0 lg:overflow-y-auto">
        <div>
          {/* Organisation Header */}
      ...
      <main className="flex-1 flex flex-col min-w-0 lg:h-screen overflow-hidden">
        {/* Top Operational Bar */}
        <header className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 px-4 sm:px-8 py-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 shadow-2xs shrink-0">
          <div className="flex items-center gap-3">
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-8 pb-20 sm:pb-28 relative scroll-smooth">
          {globalLoading && (
